...
class ObjectDetectionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Apply Photometric / Spatial transforms (Flip, Color Jitter, Multi-scale Resize, Normalize)
        if self.transforms is not None:
            image_tensor, boxes_tensor, labels_tensor, (orig_h, orig_w) = self.transforms(
